...
const LIBRARY = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        title: "Land Forbidden Foods Guide",
        file: "Modern diet and disease/land-forbidden-foods-guide.html",
        icon: "🐄",
        tag: "Health",
        tagClass: "green",
        desc: "A focused breakdown of land animal dietary restrictions, what Scripture identifies as unclean, and supporting scientific context.",
      },
      {
